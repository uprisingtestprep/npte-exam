/* NPTE Exam Simulator, Application Logic */

const ACCESS_CODE  = "NPTE9000";
const EXAM_SECONDS = 18000;
const PASSING_PCT  = 70; // disclosed placeholder — the real NPTE uses a criterion-referenced SCALED score (pass = 600), not a fixed percentage
const STORAGE_KEY  = "npte_exam_state_v1";
const SIM_Q_COUNT  = 225;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"musculoskeletal_system": "Musculoskeletal System", "neuromuscular_and_nervous_system": "Neuromuscular and Nervous System", "cardiovascular_and_pulmonary_systems": "Cardiovascular and Pulmonary Systems", "lymphatic_metabolic_endocrine_gi_and_gu_systems": "Lymphatic Metabolic Endocrine GI and GU Systems", "integumentary_system": "Integumentary System", "system_interactions": "System Interactions", "equipment_devices_and_therapeutic_modalities": "Equipment Devices and Therapeutic Modalities", "safety_protection_and_professional_responsibilities": "Safety Protection and Professional Responsibilities", "research_and_evidence_based_practice": "Research and Evidence-Based Practice"};  // maps domain key -> human-readable label for display
